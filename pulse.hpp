...
class Pulse {
  ...
  private:
    ...
    // Proposal responses
    bool awaiting_response_received_; ///< True if our proposal got an ACK
    bool awaiting_response_is_ack_;   ///< True if our proposal got a REJ
    ...
    std::optional<std::string>
        pending_response_to_;      ///< Proposal ID we are responding to
